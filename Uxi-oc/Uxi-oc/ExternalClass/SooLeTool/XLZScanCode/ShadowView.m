...
- (void)layoutSubviews{
    ...
    if (!_timer) {
        ...
        /** 自动播放 **/
        self.timer = [NSTimer scheduledTimerWithTimeInterval:2.0 target:self selector:@selector(playAnimation) userInfo:nil repeats:YES];
 ...
 - (void)drawRect:(CGRect)rect {
     ...
     [self addCornerLineWithContext:ctx rect:rect];
